    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/online_registration"
            element={<Online_registration />}
          />
          <Route path="/certificate" element={<Certificate />} />
          <Route path="/Carrer_guidance" element={<Carrer_guidance />} />
          <Route path="/courses" element={<Layout />}>
            <Route
              path="diploma_in_cloud_computing_and_cyber_security"
              element={<Diploma_in_cloud_computing_and_cyber_secuity />}
            />
            <Route
              path="diploma_in_computer_networking,_cloud_computing_&_ai"
              element={<Diploma_in_cloud_computing_cloud_computing_Ai />}
            />
          </Route>
        </Routes>
        <Companies/>
